...
REG_ORDER = ["GBR", "EU27", "ZAF", "RUS", "CHN", "KOR", "JPN",
             "IND", "AUS", "CAN", "USA", "BRA", "ROW"]

# --- load ICIO -------------------------------------------------------------
ic = pd.read_csv("DATA_13R/ICIO2025_13R_2022.csv", index_col=0)
...
ci = pd.read_csv("DATA_13R/CARBON_INTENSITY_13R_2022.csv", index_col=0)
