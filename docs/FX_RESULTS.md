...
| `tests/test_extensions.py` | 92 | physical, mixture, volatility, tariff and specification layers — including that the transition shock is *absent* from both the rate shift and the op-risk channel |
