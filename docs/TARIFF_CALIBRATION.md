...
> This is the companion to [TARIFF_METHOD.md](TARIFF_METHOD.md), which describes
> the mechanism and illustrates it on a single assumed case. This note is the
> harder half: matching the machinery to tariff measures actually in force as of
> mid-2026, and the assumptions that requires. Read the method note first.
